...
@property NSInteger availableNight;                     // flag, 1 = participant is available in the night for notifications
@property NSInteger availableVEarly;                    // flag, 1 = participant is available in the very early morning for notifications
