...
@interface AskWatchAgainViewController ()

@end

@implementation AskWatchAgainViewController
...
- (IBAction)buttonPressedYes:(CGradientButton *)sender {
    [GlobalData sharedManager].videoWatchAgain = VIDEO_WATCH_AGAIN_YES; // save result
...
- (IBAction)buttonPressedNo:(CGradientButton *)sender {
    [GlobalData sharedManager].videoWatchAgain = VIDEO_WATCH_AGAIN_NO; // save result
