...
@property int timeOfDayAvailVEarly;    // user is available in very early morning for recommendation
...
@property int timeOfDayAvailNight;    // user is available in night for recommendation
